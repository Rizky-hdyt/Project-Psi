...
export const QA_BANK: QAEntry[] = [
  ...
  },
  {
    ...
    answer: () =>
      "Indikator Biaya Hidup arahnya dibalik: makin rendah biaya hidup di distrik itu, makin tinggi skornya — 100 berarti paling terjangkau.",
  },
  {
  ...
  },
  {
    ...
    answer: () =>
      "Indikator Lingkungan menilai kenyamanan tempat kerja (cafe, coworking, ketenangan) sesuai preferensi Anda — makin tenang & mendukung, makin tinggi skornya.",
  },
  {
    id: "tiebreaker",
